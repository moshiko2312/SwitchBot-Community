...
### 1. קודן SwitchBot Keypad Vision / Keypad Touch

![קודן SwitchBot Keypad Vision / Keypad Touch](docs/images/01-product-keypad.svg)

### 2. מסך כניסה

![מסך כניסה](docs/images/02-login-screen.svg)

### 3. מדריך התקנה מובנה בתוך ממשק הבקר

![מדריך התקנה מובנה בתוך ממשק הבקר](docs/images/03-built-in-guide.svg)

### 4. תפריט פעולות, בחירת שפה ומדריך התקנה

![תפריט פעולות, בחירת שפה ומדריך התקנה](docs/images/04-actions-language-guide.svg)
...
### 8. מסך משתמשים וקודנים בממשק עברי

![מסך משתמשים וקודנים בממשק עברי](docs/images/08-hebrew-users-keypads.svg)
...
### 11. תהליך שיוך הקודן לבקר

![תהליך שיוך הקודן לבקר](docs/images/11-pairing-process.svg)

### 12. שיוך הקודן הסתיים בהצלחה

![שיוך הקודן הסתיים בהצלחה](docs/images/12-pairing-success.svg)
